        ...
        scene.setOnKeyPressed(new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent ke) {
               ...
               if(cc==37 ){System.out.print("LEFT");}
                ...
                if(getDrirection=="LEFT"|getDrirection=="RIGHT"|getDrirection=="UP"|getDrirection=="DOWN"){worm.changeDirection(getDrirection);}
                if(getDrirection=="S") {
                    try {
                        saveState();
                    }
...
public class AliveTask extends TimerTask{
    ...
    public void loadState() throws FileNotFoundException, IOException, ClassNotFoundException {
       ...
       // Worm w1;
        ...
        //worm.cells = (HashMap<Integer, Worm.Cells>) ois.readObject();
